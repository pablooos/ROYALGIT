module.exports = {
	...
	subtitle: function(data) {
		const categories = ['You cheater!', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
	...
	html: function(isEvent, data) {
		return `
			...
			<div class="embedinfo">
			<span class="embed-auth"><u>Informacje o modzie:</u><br>Made by <b>${this.author}</b></span><br>
