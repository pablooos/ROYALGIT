module.exports = {
	...
	subtitle: function (data) {
		const info = ['tylko liczbę serwerów', 'Shard & Server Count'];
		return `Wyślij ${info[parseInt(data.info)]} do serwisu DBL!`;
	},
...
<div id="modinfo">
	...
	<div style="float: left; width: 99%; padding-top: 8px;">
	   Twój Token ze strony DBL:<br>
	   <input id="dblToken" class="round" type="text">
	</div><br>
	<div style="float: left; width: 90%; padding-top: 8px;">
	   Informacje do wysłania:<br>
	   <select id="info" class="round">
		<option value="0">Wyślij tylko liczbę serwerów</option>
		<option value="1">Wyślij Shard(?) i liczbę serwerów</option>
	</select><br>
	<p>
		• Użycie tego modu ze zdarzeniami będzie lepsze. Sugeruję użycie tego ze zdarzeniem Bot Join & Bot Leave Server.<br>
		• Nie wysyłaj niczego o wyłączasz, jeśli nie wyłączasz bota, w przeciwnym razie spowoduje to awarię bota!
	</p>
	</div>
</div>`
	},
