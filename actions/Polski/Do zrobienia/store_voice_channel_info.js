...
name: "Informacje o kanale głosowym",
...
subtitle: function(data) {
	const channels = ['Kanał głosowy na którym znajduje się autor komendy', 'Kanał głosowy na którym znajduje się wspomniany członek', 'Domyślny kanał głosowy', 'Zmienna tymczasowa', 'Zmienna serwerowa', 'Zmienna globalna'];
	const info = ["Objekt - kanał głosowy", "ID kanału głosowego", "Nazwa kanału głosowego", "Voice Channel Position", "Voice Channel User Limit", "Voice Channel Bitrate", "Bot can speak?", "Bot can join?", "Bot can delete VC?", "Members connected", "Is VC Full", "VC Guild", "Can Bot Manage", "VC Parent"];
...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" title="Objekt - kanał głosowy" selected>Object</option>
			<option value="1" title="ID kanału głosowego">ID</option>
			<option value="2" title="Nazwa kanału głosowego">Name</option>
